...
with open('usefulness.csv') as usefulness_csv:
    ...
    for rank, letters, words_str, removed_str, length, count, usefulness, best_word, stems, old_word in reader:
...
with open('anadict.json', 'w') as anadict:
    json.dump(anagrams, anadict)
